...
purpose (authorized web application reconnaissance, single-target scope, no
internet-wide scanning, no unauthorized-access or exploitation tooling) even
if technically sound. This is a deliberate boundary, not an error.
