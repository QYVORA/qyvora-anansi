...
USER    ?= $(shell id -u -n)
GOFLAGS := -ldflags="-s -w -X github.com/QYVORA/qyvora-anansi/internal/version.Version=$(VERSION) -X github.com/QYVORA/qyvora-anansi/internal/version.Commit=$(COMMIT) -X github.com/QYVORA/qyvora-anansi/internal/version.Date=$(DATE) -X github.com/QYVORA/qyvora-anansi/internal/version.BuildUser=$(USER)" -trimpath
